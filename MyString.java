...
public class MyString {
    public static void main(String args[]) {
        ...
        System.out.println(spacedString("hello"));   // Output: "h e l l o"
    ...
    public static boolean subsetOf(String str1, String str2) {
        String remainingCharacters = str2;
        for(int i = 0; i < str1.length(); i++) {
            char ch = str1.charAt(i);
            int index = remainingCharacters.indexOf(ch);
            if(index == -1) {
                return false;
            }
            remainingCharacters = remainingCharacters.substring(0, index) + remainingCharacters.substring(index + 1);
        }
        return true;
    }
    ...
    public static String randomStringOfLetters(int n) {
        String randomWord = "";
        for(int i = 0; i < n; i++) {
            int randomNumber = 97 + (int) (Math.random() * (122 - 97 + 1));
